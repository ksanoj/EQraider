...
local showGUI = true
local openGUI = true
local showMainUI = true  -- Track main window visibility (false = minimized)
...
local buffChecks = {
    ...
    {name = "Heroic Focusing", class = "shm", includeClasses = nil, excludeClasses = {"ENC", "CLR", "MAG", "NEC", "WIZ", "PAL"}},
    {name = "Spirit of Tala'Tak", class = "shm", includeClasses = nil, excludeClasses = nil},
    {name = "Benediction of Devotion", class = "clr", includeClasses = nil, excludeClasses = nil},
    {name = "Symbol of Helmsbane", class = "clr", includeClasses = nil, excludeClasses = nil},
    {name = "Ward of the Avowed", class = "clr", includeClasses = nil, excludeClasses = nil},
    {name = "Emberquartz Blessing", class = "dru", includeClasses = nil, excludeClasses = {"CLR"}},
    {name = "Illusion Benefit Greater Jann", class = "item", includeClasses = nil, excludeClasses = nil},
    {name = "Familiar: Scalewrought Flyer", class = "item", includeClasses = nil, excludeClasses = nil},
    {name = "Geomantra", class = "item", includeClasses = nil, excludeClasses = nil},
    {name = "Voice of Preordination", class = "enc", includeClasses = nil, excludeClasses = {"WAR", "BER", "MNK", "ROG", "NEC"}},
    {name = "Hastening of Margator", class = "enc", includeClasses = nil, excludeClasses = {"DRU", "MAG", "NEC", "WIZ"}},
    {name = "Night's Eternal Terror", class = "enc", includeClasses = nil, excludeClasses = nil},
    {name = "Spiritual Enduement", class = "bst", includeClasses = nil, excludeClasses = nil},
    {name = "Shared Merciless Ferocity", class = "bst", includeClasses = nil, excludeClasses = nil},
    {name = "Circle of Forgefire Coat", class = "mag", includeClasses = nil, excludeClasses = nil},
